...
aws ecr describe-images --repository-name newsrag-api --region ap-southeast-2
```
**Expected:** Image with `latest` tag exists.
...
```
**Expected:** `newsrag-consumer`, `newsrag-etl`, `newsrag-rag-api`
...
```
**Expected:** Terraform apply success, Docker build success, ECR push success.
...
# Note: Actual AWS resources are cleaned via terraform destroy (see Section 5.17)
```
