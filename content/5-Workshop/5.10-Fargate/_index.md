...
- Terraform infrastructure deployed (see Section 5.3)
- Docker image built and pushed to ECR (see Section 5.9)
- AWS CLI configured
- ECS Cluster `newsrag-cluster` exists
...
# Note: Full cleanup via terraform destroy (see Section 5.17)
```
