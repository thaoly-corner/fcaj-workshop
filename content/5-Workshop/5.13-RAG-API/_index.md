...
- Aurora pgvector with embedded data (see Section 5.12)
...
```bash
# No temporary resources for this step
# API Gateway + Lambda cleaned via terraform destroy (see Section 5.17)

# Optionally delete test log streams
